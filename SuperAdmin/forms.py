...
class IcuBedForm(forms.ModelForm):
    class Meta:
        model = IcuBed
        fields = ['hospital', 'icu_bed_number']


class OxygenCylinderForm(forms.ModelForm):
    class Meta:
        model = OxygenCylinder
        fields = ['hospital', 'oxygen_cylinder_number']
...
class OxygenCylinderUpdateForm(forms.ModelForm):
    class Meta:
        model = OxygenCylinder
        fields = ['oxygen_cylinder_number']


class PlasmaForm(forms.ModelForm):
    class Meta:
        model = Plasma
        fields = ['donor_name', 'hospital', 'blood_group', 'donor_location', 'phone_number']
